...
한 문장에 내 일이 완성된 형태로 쓰이지 않아도, 여러 발화의 맥락을 묶어 내가 해야 할 일정 후보를 찾는다. 동시에 다른 사람의 일은 제외한다.
...
|---|---|---|---|---|---|
| C1 | 고객사 B 자료 전달 | follow_up | "최종본은 현우님 쪽에서 들고 계시죠?" / "현우: 네, 제가 확인해볼게요." / "그럼 내일 오전 10시까지 고객사에 전달되면 좋겠습니다." | 2026-05-23 10:00 | 없음 |
